                              ...
                              return Hero(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      image: DecorationImage(onError: (exception, stackTrace) => Icon(Icons.error),
                                          opacity: 0.70,
                                          image: NetworkImage(value.profileList[0].image,),
                                          fit: BoxFit.cover)),
                                ),
                              );
                            },
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                acadamicInfo(
                                    text: 'Week',
                                    text2:
                                        value.profileList[0].week.toString()),
                                acadamicInfo(
                                    text: 'Advisor',
                                ...
                                acadamicInfo(
                                    text: 'Qualification',
                                    text2: value
                                        .profileList[0].qualification.name!),
                                acadamicInfo(
                                    text: 'Joining Date',
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                acadamicInfo(
                                    text: 'Institution',
                                    text2:
                                        value.profileList[0].institution.name!,
                                    icon: Icons.school),
                                acadamicInfo(
                                    text: 'PassOut Year',
